...
**Goal:** Read the individual routine log files in `content/jules/reports/`, analyze feedback from previous routine executions, apply improvements to the respective routine files, and archive the processed logs.
...
* **Upon successful completion, you MUST write a short log (including date, routine name, success status, and a summary of how many routines you improved) to a new markdown file in `content/jules/reports/` (e.g., `content/jules/reports/[date]-self-improvement-pass.md`).**
