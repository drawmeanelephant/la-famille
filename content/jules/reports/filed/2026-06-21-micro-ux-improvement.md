...
**Details:**
Executed the micro-ux-improvement routine. I identified and fixed missing `focus-visible` states in `templates/layout-devlog.html` and `templates/layout-split-screen.html`.
