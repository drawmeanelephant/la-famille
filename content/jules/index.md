...
* **2026-06-21**: TUI and Server enhancements - Added `serve` CLI command, TUI full-terminal mode (`WithAltScreen`), and integrated local server with dancing mascot into the TUI.
