...
> **Note:** `rag-archive/` is generated by `go run ./cmd/la-famille rag`. It is intentionally ignored and must not be edited or committed. The Pages workflow may publish a copy under `public/rag-archive/`.
